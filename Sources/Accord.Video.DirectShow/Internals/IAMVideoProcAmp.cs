...
{
    /// <summary>
    /// The IAMVideoProcAmp interface controls video settings such as brightness, contrast, or hue.
    /// To obtain this interface, query the filter that controls the camera.
    /// </summary>
